...
public class ConnectDbU {
    ...
    public Properties loadProperties() throws IOException {
        ...
        InputStream ism = new FileInputStream("/Users/bravo1516/Web-Automation-Framework/TeamSeven/Statefarm/src/test/resources/secret.properties");
        prop.load(ism);
        ism.close();
        return prop;
    }
